<template>
    ...
    <div v-if="isLoading">
      <div class="loadingio-spinner-magnify-vs28tos9p0a"><div class="ldio-uwcdksru16">
  ...
  submitForm() {
    ...
    axios.post('http://localhost:8084/users/ordertaxi', formData)
      .then(response => {
        this.errorLog = false
...
.ldio-uwcdksru16 div { box-sizing: content-box; }
